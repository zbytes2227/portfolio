...
<div className="max-w-sm border border-gray-500 rounded-lg bg-white bg-opacity-5 backdrop-blur-sm shadow mt-10">
    ...
    <div class="p-5">
        ...
        <a href={`/blogs?name=${name}`} class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            See more
